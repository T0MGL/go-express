...
const CLIENTE_COLUMNS = 'id, auth_id, razon_social, ruc, contacto_nombre, contacto_cargo, telefono, email, direccion, ciudad, estado, plan, total_envios, envios_activos, notas, portal_activo, portal_status, portal_invited_at, es_mostrador, eliminado, eliminado_por, eliminado_en, motivo_eliminacion, created_at, updated_at';
