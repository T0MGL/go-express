...
export const estadoDescripciones: Record<string, string> = {
  ...
  en_transito: 'En camino al depósito',
  en_deposito: 'Paquete en depósito, listo para despacho',
...
// Departamentos de Paraguay. Orden: Asuncion (distrito capital) primero,
// despues alfabetico. Los 18 oficiales segun DGEEC. El catalogo de ciudades
// por departamento vive en la DB y se consume via useCiudades().
